...
Now we can use the features from the extension directly in DuckDB. The template contains a single scalar function `llm()` that takes a string arguments and returns a string:
```sql
